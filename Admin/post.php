...
if (($number == "1") && ($adminpowerpagepost == 'yes')) {
...
$sql = "INSERT INTO $pagestable (title, page) VALUES ('$titlepage', '$news')";
$result = mysql_query($sql);
echo "<p class='header'>Page added.</p>";
}
else {
?>
<p class="header">Create page.</p>
...
<tr>
<td><input type="Text" size="45" name="titlepage" style="background-color: <?php echo"$color5" ?>; border: 1 solid <?php echo"$color1" ?>" class="text"><br></td>
</tr>
<tr>
<td><p class="text">Content:</p></td>
</tr>
<tr>
